  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div className="relative flex flex-col place-items-center text-center">
        <h1 className="mb-4 text-5xl font-extrabold">Himanshu&apos;s Portfolio</h1>
        <p className="mb-8 text-xl">Welcome to my personal website where I share my weekly learnings and professional experience.</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8">
          ...
          >
            ...
            <p className="m-0 max-w-[30ch] text-sm opacity-50">
              Check out what I learned each week
            </p>
          </Link>
